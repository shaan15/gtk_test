...
static void
my_button_add (GtkContainer *button, 
				GtkWidget *child)
{
...
my_button_class_init (MyButtonClass *Class)
{
	...
	container_class->add = my_button_add;
}

static void
my_button_finalise (GObject *object)
{
	G_OBJECT_CLASS (my_button_parent_class)->finalise (object);
}

static gboolen
my_button_draw (GtkWidget *widget, cairo_t *cr)
{
